import { OTISSecurityGateway, RBAC_POLICIES } from '../../src/otis/security-gateway';

describe('OTIS Security Gateway', () => {
  let gateway: OTISSecurityGateway;

  beforeEach(() => {
    gateway = new OTISSecurityGateway();
  });

  describe('RBAC', () => {
    it('should allow admin all permissions', () => {
      const policy = RBAC_POLICIES['admin'];
