...
class TestFileSystemAgent:
    ...
    async def test_write_and_read_file(self, temp_workspace):
        ...
        agent = FileSystemAgent(
            agent_id="fs_test",
            config={"root_dir": temp_workspace, "allowed_extensions": [".txt", ".md"]},
        )
        ...
        read_result = await agent.execute_task(
            {"payload": {"operation": "read_file", "path": "test.txt"}}, context
        )
    ...
    async def test_extension_restriction(self, temp_workspace):
        ...
        agent = FileSystemAgent(
            agent_id="fs_test",
            config={"root_dir": temp_workspace, "allowed_extensions": [".txt"]},
        )
