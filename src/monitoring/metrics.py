...
# Task metrics
task_total = Counter('astro_tasks_total', 'Total tasks executed', ['agent_id', 'status'])
task_duration = Histogram('astro_task_duration_seconds', 'Task duration', ['agent_id'],
...
workflow_duration = Histogram('astro_workflow_duration_seconds', 'Workflow duration',
...
agent_tasks_active = Gauge('astro_agent_tasks_active', 'Active tasks per agent', ['agent_id'])
agent_reliability = Gauge('astro_agent_reliability', 'Agent reliability score', ['agent_id'])
...
llm_duration = Histogram('astro_llm_duration_seconds', 'LLM request duration', ['model'],
...
db_duration = Histogram('astro_db_query_duration_seconds', 'Query duration', ['operation'],
